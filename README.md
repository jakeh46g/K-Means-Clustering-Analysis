...
1. Click the "Open in Colab" badge at the top of `K_Means_Clustering.ipynb`
...
```bash
# Clone repository (includes dataset nestegg.csv)
...
The notebook loads data from Google Drive by default. To run locally:
...
2. **Update data path**: Change the data loading line from:
   ```python
